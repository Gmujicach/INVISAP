...
-- -----------------------------------------------------
-- Table `gestionar_proyectos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_proyectos` ;

CREATE TABLE IF NOT EXISTS `gestionar_proyectos` (
  ...
  CONSTRAINT `fk_gestionar_proyectos_gerencias1`
    ...
    REFERENCES `gerencias` (`id_gerencias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `gestionar_obra`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_obra` ;

CREATE TABLE IF NOT EXISTS `gestionar_obra` (
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  CONSTRAINT `fk_empresa_gestionar_proyectos1`
    ...
    REFERENCES `gestionar_proyectos` (`id_proyectos` , `maquinaria_id_maquinaria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_empresa_gestionar_obra1`
    FOREIGN KEY (`gestionar_obra_id_inspeccion`)
    REFERENCES `gestionar_obra` (`id_inspeccion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `gestionar_contrataciones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_contrataciones` ;

CREATE TABLE IF NOT EXISTS `gestionar_contrataciones` (
  ...
  CONSTRAINT `fk_gestionar_contrataciones_empresa1`
    ...
    REFERENCES `empresa` (`rif` , `gestionar_proyectos_id_proyectos` , `gestionar_proyectos_maquinaria_id_maquinaria`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `gestionar_solicitudes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_solicitudes` ;

CREATE TABLE IF NOT EXISTS `gestionar_solicitudes` (
...
-- -----------------------------------------------------
-- Table `gestionar_prioridad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_prioridad` ;

CREATE TABLE IF NOT EXISTS `gestionar_prioridad` (
...
-- -----------------------------------------------------
-- Table `gestionar_gravedad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_gravedad` ;

CREATE TABLE IF NOT EXISTS `gestionar_gravedad` (
...
-- -----------------------------------------------------
-- Table `priorizar_solicitudes`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `priorizar_solicitudes` ;

CREATE TABLE IF NOT EXISTS `priorizar_solicitudes` (
...
-- -----------------------------------------------------
-- Table `gerencias_has_empleados`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gerencias_has_empleados` ;

CREATE TABLE IF NOT EXISTS `gerencias_has_empleados` (
  `gerencias_id_gerencias` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `gestionar_publicaciones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gestionar_publicaciones` ;

CREATE TABLE IF NOT EXISTS `gestionar_publicaciones` (
...
-- -----------------------------------------------------
-- Table `informe_avance_obra_has_gestionar_publicaciones`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `informe_avance_obra_has_gestionar_publicaciones` ;

CREATE TABLE IF NOT EXISTS `informe_avance_obra_has_gestionar_publicaciones` (
  `informe_avance_obra_id_informe` INT NOT NULL,
  ...
  CONSTRAINT `fk_informe_avance_obra_has_gestionar_publicaciones_gestionar_1`
    ...
    REFERENCES `gestionar_publicaciones` (`id_publicaciones`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
...
-- -----------------------------------------------------
-- Table `gerencias_has_gestionar_prioridad`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gerencias_has_gestionar_prioridad` ;

CREATE TABLE IF NOT EXISTS `gerencias_has_gestionar_prioridad` (
  `gerencias_id_gerencias` INT NOT NULL,
  ...
  CONSTRAINT `fk_gerencias_has_gestionar_prioridad_gerencias1`
    ...
    REFERENCES `gerencias` (`id_gerencias` , `informe_avance_obra_id_informe`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
