      ...
      steps: [
        {
          ...
          popover: {
            ...
            description: 'Administre las empresas registradas para procesos de contratacion, contactos y facturacion en el sistema.'
          },
          side: 'bottom'
        },
        {
          ...
          popover: {
            ...
            description: 'Filtre por RIF, nombre de empresa, telefono o domicilio fiscal. Primero seleccione la columna, luego escriba.'
          },
          side: 'bottom'
        },
        {
          ...
          popover: {
            ...
            description: 'Listado con RIF, nombre comercial, telefono de contacto y domicilio fiscal de todas las empresas.'
          },
          side: 'top'
        },
        {
