...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ '4773c216-9e66-11f1-8782-c4346b70723b:1-1457';
...
CREATE TABLE `avance` (
  ...
  CONSTRAINT `fk_avance_empleado1` FOREIGN KEY (`gerente`) REFERENCES `empleados` (`id_empleados`)
...
INSERT INTO `avance` VALUES ('0780c1c2a553',67,'Carretera Nacional hay que reparar',6,'2026-07-04',24,1,1,'FRE-001',1),('098264b7eef9',50,'Test obs',1,'2026-07-05',24,1,1,'FRE-001',1),('0a9a55ead39b',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',4,1,1,'FRE-001',1),('0c8eb3a83706',28,'hay que asfaltar equisde',1,'2026-07-05',24,1,1,'FRE-001',1),('113a14ea70b7',50,'reparar la Comunidad',6,'2026-07-05',24,1,1,'FRE-001',1),('15e07374f523',64,'En la comunidad Nuevo horizonte',6,'2026-07-02',24,1,1,'FRE-001',1),('1c039681733a',90,'Updated',1,'2026-07-05',24,1,1,'FRE-001',1),('1df486355cd0',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',8,1,1,'FRE-001',1),('1df6b8f707d0',25,'Prueba',1,'2026-07-01',19,1,1,'FRE-001',1),('22a8d98cd659',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',18,1,1,'FRE-001',1),('2eb5dc872fcf',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',11,1,1,'FRE-001',1),('3d03370f9b8b',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',13,1,1,'FRE-001',1),('4881290ca4c3',7,'hay que reparar en Av. Intercomunal',6,'2026-07-04',24,1,1,'FRE-001',1),('49143e692fde',7,'hay que reparar en Av. Intercomunal',6,'2026-07-04',24,1,1,'FRE-001',1),('5bdbc3bb4ed7',48,'esto es un informe muy serio y muy largo así ',6,'2026-08-14',24,1,1,'FRE-001',1),('5e48bd43ec2b',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',17,1,1,'FRE-001',1),('6d2ff375fef8',30,'Test',1,'2026-07-05',24,1,1,'FRE-001',1),('7317ea5dba7d',44,'Sector La Aguada se necesita asfaltar',1,'2026-07-04',24,1,1,'FRE-001',1),('752f90f2b837',100,'en la urbanizacion hay que asfaltar',1,'2026-07-04',24,1,1,'FRE-001',1),('7a4e67e5c2ce',40,'Siguiendo Las Instrucciones del gobernador Cm',1,'2026-07-06',24,1,1,'FRE-001',1),('7abe4665215b',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',16,1,1,'FRE-001',1),('80e3115d8f95',44,'Sector La Aguada se necesita asfaltar',1,'2026-07-04',24,1,1,'FRE-001',1),('83bc77674b51',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',15,1,1,'FRE-001',1),('86e4fcc4dfbe',100,'Se termino de reconstruir la vía para darle paso a los vehículos y a los peatones',1,'2026-08-18',24,1,1,'FRE-001',1),('8c961919a946',67,'Se ha constatado una obstrucción crítica en la vía principal de la Comunidad La Salle en El Cují, la cual interrumpe de manera parcial/total el libre tránsito vehicular y peatonal. Dicha interrupción se origina por la acumulación de sedimentos, material granular y/o fallas conexas en el sistema de drenaje superficial, lo que ha propiciado el colapso operativo del tramo afectado.\r\n2. Evaluación de Riesgos y Afectaciones\r\n\r\n    Vulnerabilidad Vial: La presencia de este obstáculo genera un embotellamiento del tráfico local, incrementando el riesgo de colisiones y dificultando el acceso de vehículos de emergencia y transporte público a la zona residencial.\r\n\r\n    Sistema de Drenaje: Se observa un estancamiento de aguas pluviales debido a la obstrucción de lasalcantarillas y cunetas, lo que acelera el deterioro prematuro de la capa de rodamiento (asfalto/concreto) por saturación de la sub-base.\r\n\r\n    Seguridad Peatonal: Los transeúntes, en especial niños y adultos mayores, se ven en la obligación de invadir el canal de circulación vehicular para sortear el área afectada, exponiéndose a situaciones de peligro inminente.\r\n\r\n3. Conclusiones y Recomendaciones Técnicas\r\n\r\n    Remoción Inmediata: Se requiere la movilización prioritaria de maquinaria pesada (minicargador o retroexcavadora) y cuadrilla de obreros para el saneamiento, despeje y retiro de escombros o material sedimentado en la calzada.\r\n\r\n    Mantenimiento Preventivo de Drenajes: Realizar una inspección con hidrojet o limpieza manual de los colectores y cunetas adyacentes para garantizar la fluidez hidráulica y evitar futuras inundaciones o socavaciones en la vía.\r\n\r\n    Señalización Temporal: Colocar señalización preventiva de obra (conos, vallas y cinta de peligro) en el perímetro afectado para alertar a los conductores sobre la reducción de la calzada, mitigando así el riesgo de accidentes durante las horas nocturnas y diurnas.',1,'2026-08-10',24,1,1,'FRE-001',1),('8e85d8b4f2a0',25,'Test',1,'2026-07-05',24,1,1,'FRE-001',1),('9214ff06713f',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',7,1,1,'FRE-001',1),('942e517e2048',38,'En Tamaca hay que asfaltar',1,'2026-07-04',24,1,1,'FRE-001',1),('9594c25e7a16',48,'esto es un informe muy serio y muy largo así ',6,'2026-08-14',24,1,1,'FRE-001',1),('9a6e2816e7f4',100,'Se termino de reconstruir la vía para darle paso a los vehículos y a los peatones',1,'2026-08-18',24,1,1,'FRE-001',1),('a09e4dfbbe8c',64,'En la comunidad Nuevo horizonte',6,'2026-07-02',23,1,1,'FRE-001',1),('a12e302ae883',100,'En la Luis Hurtado se arreglo la via',1,'2026-07-01',14,1,1,'FRE-001',1),('ad20d3759114',13,'En Av. Intercomunal se hizo un asfaltado y em',5,'2026-07-03',24,1,1,'FRE-001',1),('ae8c50e964e9',50,'reparar la Comunidad',6,'2026-07-05',24,1,1,'FRE-001',1),('b07c92e0e7ff',13,'En Av. Intercomunal se hizo un asfaltado y em',5,'2026-07-03',24,1,1,'FRE-001',1),('b0d8247b2d01',100,'en Morán hay que reparar',1,'2026-07-06',24,1,1,'FRE-001',1),('b25c0cb85384',16,'En san francisco se hizo un bache',6,'2026-07-01',21,1,1,'FRE-001',1),('b70e531c3f5f',30,'En Cabudares nos informaron de que no cargan ',5,'2026-06-30',2,1,1,'FRE-001',1),('b7b4eb5ecb30',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',3,1,1,'FRE-001',1),('b7c87235e5e2',16,'En san francisco se hizo un bache',6,'2026-07-01',20,1,1,'FRE-001',1),('b7ed15f05b88',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',9,1,1,'FRE-001',1),('bc2a0329e738',56,'Hay que reparar algo',10,'2026-07-07',24,1,1,'FRE-001',1),('beda52ea9bd1',50,'Test obs',1,'2026-07-05',24,1,1,'FRE-001',1),('bf0e7abdad06',93,'En el Cují, en la Calle 3 se realizara un asf',5,'2026-07-04',24,1,1,'FRE-001',1),('c0ecec782081',38,'reparaciones en Cabudares',1,'2026-07-03',24,1,1,'FRE-001',1),('c46ec2a9eb43',39,'En el Sector La Aguada se realizaran reparaci',10,'2026-07-07',24,1,1,'FRE-001',1),('d159b72e9c16',28,'En la Salle se comenzo a hacer una obra',1,'2026-07-04',24,1,1,'FRE-001',1),('d169eb15ef98',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',12,1,1,'FRE-001',1),('d3c620ff34ad',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',5,1,1,'FRE-001',1),('d9b6d8dfb228',38,'reparaciones en Iribarren Av. Venezuela',1,'2026-07-03',24,1,1,'FRE-001',1),('dd708c7466cf',93,'En el Cují, en la Calle 3 se realizara un asf',5,'2026-07-04',24,1,1,'FRE-001',1),('e316f1191384',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',6,1,1,'FRE-001',1),('e862a33d0c7c',100,'en la urbanizacion hay que asfaltar',1,'2026-07-04',24,1,1,'FRE-001',1),('f0457b38b0cb',48,'esto es un informe muy serio y muy largo así ',6,'2026-08-14',24,1,1,'FRE-001',1),('f220e9404f00',100,'En la Luis Hurtado se llevo a cabo la restaur',5,'2026-07-01',10,1,1,'FRE-001',1),('f644e245bfb0',48,'esto es un informe muy serio y muy largo así ',6,'2026-08-14',24,1,1,'FRE-001',1),('fa7f402d9b98',13,'En Av. Intercomunal se hizo un asfaltado y em',5,'2026-07-03',24,1,1,'FRE-001',1),('fb5af05a3a48',25,'Prueba',1,'2026-07-01',22,1,1,'FRE-001',1),('fef7ab9d0883',69,'Se esta restaurando la via de Pueblo Nuevo',6,'2026-06-30',1,1,1,'FRE-001',1);
...
INSERT INTO `empresa` VALUES ('12','Polar','04122212121','Calle 13c',0,0),('J-714712571','Empresa Pereira','0414-5125412','Calle 14, Sector Centro',1,1),('V-879954788','Empresa Mortadela Grande','0414-4469897','Calle 5 con Av. Carúpano, Caracas, Distrito Capital, 1010',1,1);
...
CREATE TABLE `inspeccion` (
  ...
  CONSTRAINT `fk_inspeccion_empleado1` FOREIGN KEY (`inspector`) REFERENCES `empleados` (`id_empleados`),
...
CREATE TABLE `obra` (
  ...
  CONSTRAINT `fk_obra_estado` FOREIGN KEY (`estado`) REFERENCES `semaforo` (`id_semaforo`),
...
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de las inspecciones';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `obra` VALUES (30,'MORTADELA 1','Sector Mortadelandia 1','2 MESES','2026-08-24','2026-10-24','UNA PZA','91','SE COMPRAN SILLAS AA',6,'INV-BP-650',75,1,2,'WEY-001',1),(31,'MORTADELA 2','Sector Mortadelandia 2','1 MES','2026-08-24','2026-09-24','DOS PZAS','7','SE COMPRAN SILLAS AAA',79,'INV-OB-047',52,2,2,'FRE-001',1),(32,'MORTADELA 3','Sector Mortadelandia 3','6 meses','2026-08-24','2027-02-24','DOS PZAS','31','wm wqwidhd kjnfdjenb mfefdmefdnm',3,'INV-BP-005',10,3,2,'FRE-001',1);
...
CREATE TABLE `proyecto` (
  ...
  CONSTRAINT `fk_proyecto_empleado1` FOREIGN KEY (`proyecto_has_empleado`) REFERENCES `empleados` (`id_empleados`)
...
INSERT INTO `proyecto` VALUES ('FRE-001','2026-06-24 00:00:00','Restauración Vial','230 m2','200000 dolares',NULL,0),('WEY-001','2026-07-01 16:50:05','Servicio Basico ','[{\"metrica\":\"m3\",\"opcion\":\"ASFALTO\",\"costo\":\"12000\"},{\"metrica\":\"unidades\",\"opcion\":\"MURO DE GAVION\",\"costo\":\"32\"},{\"metrica\":\"kg\",\"opcion\":\"PIEDRA\",\"costo\":\"900\"}]','237523',7,1);
...
INSERT INTO `semaforo` VALUES (1,'Activo','VERDE','Por Culminar',1),(2,'Activo','AMARILLO','En progreso',1),(3,'Activo','ROJO','Paralizada',1);
...
INSERT INTO `solicitudes` VALUES (1,'2026-06-15 16:38:02','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] no hay gaz de prueba mortadela',1,1,1),(2,'2026-06-15 16:40:32','Comunidad','Completada','[Salud y Asistencia Médica] En la comunidad necesitamos una jornada de vacunación',2,1,1),(3,'2026-06-15 16:46:00','Comunidad','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] hueco en la avenida donde salen aguas negras',4,1,1),(7,'2026-06-16 17:58:23','Comunidad','En Proceso','[Infraestructura y Vialidad] Acondicionamiento vial',6,1,1),(8,'2026-06-24 16:04:42','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] No hay agua y todos nos estamos derritiendo, porfis traigan aguita aaaaaaaaa',11,1,1),(9,'2026-07-05 22:32:39','Institucion','En Proceso','[Infraestructura y Vialidad] Reparación de bacheo profundo en el acceso principal de la institución por filtraciones.',16,1,1),(10,'2026-07-07 19:59:35','Particular','En Proceso','[Salud y Asistencia Médica] Se necesita una jornada de vacunacion',18,1,1),(11,'2026-08-17 00:55:59','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] En la comunidad no hay agua',21,1,1);
...
-- Dump completed on 2026-08-26 19:34:12
