...
INSERT INTO `avance` VALUES ('0780c1c2a553',67,'Carretera Nacional hay que reparar','6','2026-07-04',24,24,1,'FRE-001'),('098264b7eef9',50,'Test obs','1','2026-07-05',24,24,1,'FRE-001'),('0a9a55ead39b',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',4,4,1,'FRE-001'),('0c8eb3a83706',28,'hay que asfaltar equisde','1','2026-07-05',24,24,1,'FRE-001'),('113a14ea70b7',50,'reparar la Comunidad','6','2026-07-05',24,24,1,'FRE-001'),('15e07374f523',64,'En la comunidad Nuevo horizonte','6','2026-07-02',24,24,1,'FRE-001'),('1c039681733a',90,'Updated','1','2026-07-05',24,24,1,'FRE-001'),('1df486355cd0',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',8,8,1,'FRE-001'),('1df6b8f707d0',25,'Prueba','1','2026-07-01',19,19,1,'FRE-001'),('22a8d98cd659',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',18,18,1,'FRE-001'),('2eb5dc872fcf',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',11,11,1,'FRE-001'),('3d03370f9b8b',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',13,13,1,'FRE-001'),('4881290ca4c3',7,'hay que reparar en Av. Intercomunal','6','2026-07-04',24,24,1,'FRE-001'),('49143e692fde',7,'hay que reparar en Av. Intercomunal','6','2026-07-04',24,24,1,'FRE-001'),('5e48bd43ec2b',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',17,17,1,'FRE-001'),('6d2ff375fef8',30,'Test','1','2026-07-05',24,24,1,'FRE-001'),('7317ea5dba7d',44,'Sector La Aguada se necesita asfaltar','1','2026-07-04',24,24,1,'FRE-001'),('752f90f2b837',100,'en la urbanizacion hay que asfaltar','1','2026-07-04',24,24,1,'FRE-001'),('7a4e67e5c2ce',40,'Siguiendo Las Instrucciones del gobernador Cm','1','2026-07-06',24,24,1,'FRE-001'),('7abe4665215b',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',16,16,1,'FRE-001'),('80e3115d8f95',44,'Sector La Aguada se necesita asfaltar','1','2026-07-04',24,24,1,'FRE-001'),('83bc77674b51',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',15,15,1,'FRE-001'),('8e85d8b4f2a0',25,'Test','1','2026-07-05',24,24,1,'FRE-001'),('9214ff06713f',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',7,7,1,'FRE-001'),('942e517e2048',38,'En Tamaca hay que asfaltar','1','2026-07-04',24,24,1,'FRE-001'),('a09e4dfbbe8c',64,'En la comunidad Nuevo horizonte','6','2026-07-02',23,23,1,'FRE-001'),('a12e302ae883',100,'En la Luis Hurtado se arreglo la via','1','2026-07-01',14,14,1,'FRE-001'),('ad20d3759114',13,'En Av. Intercomunal se hizo un asfaltado y em','5','2026-07-03',24,24,1,'FRE-001'),('ae8c50e964e9',50,'reparar la Comunidad','6','2026-07-05',24,24,1,'FRE-001'),('b07c92e0e7ff',13,'En Av. Intercomunal se hizo un asfaltado y em','5','2026-07-03',24,24,1,'FRE-001'),('b0d8247b2d01',100,'en Morán hay que reparar','1','2026-07-06',24,24,1,'FRE-001'),('b25c0cb85384',16,'En san francisco se hizo un bache','6','2026-07-01',21,21,1,'FRE-001'),('b70e531c3f5f',30,'En Cabudares nos informaron de que no cargan ','5','2026-06-30',2,2,1,'FRE-001'),('b7b4eb5ecb30',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',3,3,1,'FRE-001'),('b7c87235e5e2',16,'En san francisco se hizo un bache','6','2026-07-01',20,20,1,'FRE-001'),('b7ed15f05b88',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',9,9,1,'FRE-001'),('bc2a0329e738',56,'Hay que reparar algo','10','2026-07-07',24,24,1,'FRE-001'),('beda52ea9bd1',50,'Test obs','1','2026-07-05',24,24,1,'FRE-001'),('bf0e7abdad06',93,'En el Cují, en la Calle 3 se realizara un asf','5','2026-07-04',24,24,1,'FRE-001'),('c0ecec782081',38,'reparaciones en Cabudares','1','2026-07-03',24,24,1,'FRE-001'),('c46ec2a9eb43',39,'En el Sector La Aguada se realizaran reparaci','10','2026-07-07',24,24,1,'FRE-001'),('d159b72e9c16',28,'En la Salle se comenzo a hacer una obra','1','2026-07-04',24,24,1,'FRE-001'),('d169eb15ef98',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',12,12,1,'FRE-001'),('d3c620ff34ad',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',5,5,1,'FRE-001'),('d9b6d8dfb228',38,'reparaciones en Iribarren Av. Venezuela','1','2026-07-03',24,24,1,'FRE-001'),('dd708c7466cf',93,'En el Cují, en la Calle 3 se realizara un asf','5','2026-07-04',24,24,1,'FRE-001'),('e316f1191384',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',6,6,1,'FRE-001'),('e862a33d0c7c',100,'en la urbanizacion hay que asfaltar','1','2026-07-04',24,24,1,'FRE-001'),('f220e9404f00',100,'En la Luis Hurtado se llevo a cabo la restaur','5','2026-07-01',10,10,1,'FRE-001'),('fa7f402d9b98',13,'En Av. Intercomunal se hizo un asfaltado y em','5','2026-07-03',24,24,1,'FRE-001'),('fb5af05a3a48',25,'Prueba','1','2026-07-01',22,22,1,'FRE-001'),('fef7ab9d0883',69,'Se esta restaurando la via de Pueblo Nuevo','6','2026-06-30',1,1,1,'FRE-001');
...
INSERT INTO `comunidad` VALUES (1,'prueba02','prueba','pruuuu',2),(2,'carorita','cuji','la playa',4),(3,'hskHJS','ihjdsk','hjajda',5),(4,'Nuevo Horizonte','San Francisco','Oeste',6);
...
INSERT INTO `gravedad_obra` VALUES (1,'Alta','Crítica',1),(2,'Media','Moderada',1),(3,'Baja','Leve',1);
...
INSERT INTO `institucion` VALUES (2,'María Rodríguez','U.E.N. Lisandro Alvarado',16);
...
INSERT INTO `obra` VALUES (1,'Obra Generada','Sin ubicacion',1,'2026-06-30','2026-06-30','N/A','N/A','N/A',0,'N/A',69,1,1,'FRE-001'),(2,'Obra Generada','Sin ubicacion',1,'2026-06-30','2026-06-30','N/A','N/A','N/A',0,'N/A',30,2,1,'FRE-001'),(3,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,3,1,'FRE-001'),(4,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,4,1,'FRE-001'),(5,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,5,1,'FRE-001'),(6,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,6,1,'FRE-001'),(7,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,7,1,'FRE-001'),(8,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,8,1,'FRE-001'),(9,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,9,1,'FRE-001'),(10,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,10,1,'FRE-001'),(11,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,11,1,'FRE-001'),(12,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,12,1,'FRE-001'),(13,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,13,1,'FRE-001'),(14,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,14,1,'FRE-001'),(15,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,15,1,'FRE-001'),(16,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,16,1,'FRE-001'),(17,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,17,1,'FRE-001'),(18,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',100,18,1,'FRE-001'),(19,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',25,19,1,'FRE-001'),(20,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',16,20,1,'FRE-001'),(21,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',16,21,1,'FRE-001'),(22,'Obra Generada','Sin ubicacion',1,'2026-07-01','2026-07-01','N/A','N/A','N/A',0,'N/A',25,22,1,'FRE-001'),(23,'Obra Generada','Sin ubicacion',1,'2026-07-02','2026-07-02','N/A','N/A','N/A',0,'N/A',64,23,1,'FRE-001'),(24,'Obra Generada','Sin ubicacion',1,'2026-07-02','2026-07-02','N/A','N/A','N/A',0,'N/A',64,24,1,'FRE-001');
...
INSERT INTO `particular` VALUES (1,'Gabriel','Mujica',1),(2,'Mariangel','Bokor',11),(3,'Guillermo','Torres',18);
...
INSERT INTO `persona` VALUES (1,29957469,'CAlle 24 entre 32 y 33','Catedral','Iribarren','04128280586','gabrielenriquemch@gmail.com'),(2,34567896,'prueba','Agua Viva','Palavecino','04245678568','fedegtq2@gmail.com'),(3,56785729,'calle miami','Hilario Luna y Luna','Morán','04245678934','youtube@gmail.coom'),(4,31258936,'cuji','Freitez','Crespo','04245087200','redfiury21@gmail.com'),(5,30088284,'ihjdsk','Cabudare','Palavecino','04120587814','jose@gmail.com'),(6,28433546,'San Francisco','Guerrera Ana Soto (Juan de Villegas)','Iribarren','04123582233','mafer25@gmail.com'),(7,29345267,'Calle 52 con Carrera 24 y 25 ','Iribarren','Guerrera Ana Soto','04123456420','Juan45p@gmail.com'),(9,7833562,'Carrera 24 entre Calles 36 y 37','Iribarren','Juan de Villegas','04248379835','Cesif67@gmail.com'),(11,30587785,'Carrera 4 con Calle 5','Cabudare','Palavecino','04245319088','bokorMBmariposa@gmail.com'),(12,8977634,'Av. Los Horcones con Av. La Salle.','Catedral','Iribarren','04125677474','MejiAlejandro443@gmail.com'),(13,28542148,'Calle 9 entre Cra. 20 y 21, Casa N° 20-15','Concepción','Iribarren','04163347465','Elenaita22Ri@gmail.com'),(14,29723582,'Urb. La Rosaleda, Calle 5, Casa 12','Cabudare','Palavecino','04125543568','ElJavivi@gmail.com'),(15,29545867,'Av. Los Abogados, Res. El Parque, Torre A','Santa Rosa','Iribarren','04146564722','LaSofi23@gmail.com'),(16,12345678,'Av. Principal, Sector Centro','Catedral','Iribarren','0251-2319786','contacto@l-alvarado.edu.ve'),(17,25289197,'Calle Carabobo, Casa N° 34','Anzoátegui','Morán','04120896778','FranVier@gmail.com'),(18,28342778,'Calle 5 con Carrera 6','Freitez','Crespo','04127766654','Guille@gmail.com');
...
INSERT INTO `prioridad` VALUES (1,1,'2026-06-15 16:38:02','Sistema','Default');
...
INSERT INTO `proyecto` VALUES ('FRE-001','2026-06-24 00:00:00','Restauración Vial','230 m2','200000 dolares',0),('WEY-001','2026-07-01 00:00:00','Servicio Basico ','11513424m2','237523',1);
...
INSERT INTO `proyecto_has_maquinaria` VALUES ('FRE-001',7),('WEY-001',16);
...
INSERT INTO `proyecto_has_solicitudes` VALUES ('FRE-001',7,6,1),('WEY-001',8,11,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla general de las solicitudes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes` VALUES (1,'2026-06-15 16:38:02','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] no hay gaz de prueba mortadela',1,1),(2,'2026-06-15 16:40:32','Comunidad','Completada','[Salud y Asistencia Médica] En la comunidad necesitamos una jornada de vacunación',2,1),(3,'2026-06-15 16:46:00','Comunidad','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] hueco en la avenida donde salen aguas negras',4,1),(7,'2026-06-16 17:58:23','Comunidad','En Proceso','[Infraestructura y Vialidad] Acondicionamiento vial',6,1),(8,'2026-06-24 16:04:42','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] No hay agua y todos nos estamos derritiendo, porfis traigan aguita aaaaaaaaa',11,1),(9,'2026-07-05 22:32:39','Institucion','En Proceso','[Infraestructura y Vialidad] Reparación de bacheo profundo en el acceso principal de la institución por filtraciones.',16,1),(10,'2026-07-07 19:59:35','Particular','En Proceso','[Salud y Asistencia Médica] Se necesita una jornada de vacunacion',18,1);
...
-- Dump completed on 2026-07-07 21:17:46
