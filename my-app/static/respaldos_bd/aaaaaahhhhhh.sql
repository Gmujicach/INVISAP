...
SET @@GLOBAL.GTID_PURGED=/*!80000 '+'*/ 'd3b8d5f9-a562-11f1-a204-cc96e58a27c4:1-2329';
...
CREATE TABLE `avance` (
  ...
  CONSTRAINT `fk_avance_obra1` FOREIGN KEY (`obra_id_obra`, `obra_estado`, `obra_contratacion_id_contratacion`, `obra_gestionar_proyectos_codigo_proyecto`) REFERENCES `obra` (`id_obra`, `estado`, `contratacion_id_contratacion`, `gestionar_proyectos_codigo_proyecto`)
...
INSERT INTO `comunidad` VALUES (1,'prueba02','prueba','pruuuu',2,1),(2,'carorita','cuji','la playa',4,1),(3,'hskHJS','ihjdsk','hjajda',5,1),(4,'Nuevo Horizonte','San Francisco','Oeste',6,1),(5,'Consejo comunal Los Mangos','Zona Norte','Los Mangos',23,1);
...
CREATE TABLE `inspeccion` (
  ...
  CONSTRAINT `fk_inspeccion_obra1` FOREIGN KEY (`obra_id_obra1`, `obra_estado1`, `obra_contratacion_id_contratacion1`, `obra_gestionar_proyectos_codigo_proyecto1`) REFERENCES `obra` (`id_obra`, `estado`, `contratacion_id_contratacion`, `gestionar_proyectos_codigo_proyecto`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `particular` VALUES (1,'Gabriel','Mujica',1,1),(2,'Mariangel','Bokor',11,1),(3,'Guillermo','Torres',18,1),(4,'Susana','Torres',21,1),(5,'Angie Paola','Peña',22,1);
...
INSERT INTO `prioridad` VALUES (1,0,'Obra Mayor','Alta','ia','2026-06-15 16:38:02','admin','Clasificación IA determinista.',1),(2,0.7,'Obra Menor','Baja','ia','2026-09-02 01:57:49','admin','Clasificación IA determinista.',1),(3,0.4,'Obra Menor','Baja','ia','2026-09-02 01:57:59','admin','Clasificación IA determinista.',1),(4,0.4,'Obra Menor','Baja','ia','2026-09-02 01:58:09','admin','Clasificación IA determinista.',1),(5,0,'Obra Mayor','Alta','ia','2026-09-02 01:58:14','admin','Clasificación IA determinista.',1),(6,0.7,'Obra Menor','Baja','ia','2026-09-02 01:58:25','admin','Clasificación IA determinista.',1),(7,0.55,'Obra Menor','Baja','ia','2026-09-02 01:58:34','admin','Clasificación IA determinista.',1),(8,0.7,'Obra Menor','Baja','ia','2026-09-02 01:58:44','admin','Clasificación IA determinista.',1),(9,0.7,'Obra Menor','Baja','ia','2026-09-02 01:58:53','admin','Clasificación IA determinista.',1);
...
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla general de las solicitudes';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes` VALUES (1,'2026-06-15 16:38:02','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] no hay gaz de prueba mortadela',1,2,1),(2,'2026-06-15 16:40:32','Comunidad','Completada','[Salud y Asistencia Médica] En la comunidad necesitamos una jornada de vacunación',2,3,1),(3,'2026-06-15 16:46:00','Comunidad','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] hueco en la avenida donde salen aguas negras',4,4,1),(7,'2026-06-16 17:58:23','Comunidad','En Proceso','[Infraestructura y Vialidad] Acondicionamiento vial',6,5,1),(8,'2026-06-24 16:04:42','Particular','En Proceso','[Servicios Básicos (Agua, Luz, Gas)] No hay agua y todos nos estamos derritiendo, porfis traigan aguita aaaaaaaaa',11,6,1),(9,'2026-07-05 22:32:39','Institucion','En Proceso','[Infraestructura y Vialidad] Reparación de bacheo profundo en el acceso principal de la institución por filtraciones.',16,7,1),(10,'2026-07-07 19:59:35','Particular','En Proceso','[Salud y Asistencia Médica] Se necesita una jornada de vacunacion',18,8,1),(11,'2026-08-17 00:55:59','Particular','Pendiente','[Servicios Básicos (Agua, Luz, Gas)] En la comunidad no hay agua',21,9,1),(12,'2026-09-02 20:45:10','Particular','Pendiente','[Infraestructura y Vialidad] Pavimento presenta un hundimiento pronunciado y baches profundos que obligan a los vehículos a frenar bruscamente y a invadir el carril contrario para esquivarlos',22,1,1),(13,'2026-09-02 21:02:45','Comunidad','Pendiente','[Infraestructura y Vialidad] Entre la cancha deportiva y la panadería El Trigal el pavimento presenta desgaste con algunos baches y pequeñas grietas, los conductores presentan incomodidad y preocupación espacialmente en días de lluvia.',23,1,1);
...
-- Dump completed on 2026-09-07 11:13:52
